package com.lpl.pig.study.config;
...
import com.lpl.pig.study.utils.ApiUtil;
...
public class TokenInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        // 2. 请求时间间隔
        long reqeustInterval = LocalDateTime.now().toEpochSecond(ZoneOffset.of("+8")) - Long.valueOf(timestamp);
